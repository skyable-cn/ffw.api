...
public class Page implements Serializable {
	...
	private List<PageData> data = new ArrayList<PageData>();
	...
	public String getPageStr() {
		...
		sb.append("	<input id=\"page_currentPage\" type=\"hidden\" name=\"page_currentPage\" value=\""
				+ currentPage + "\"/>\n");
		sb.append("	<input id=\"page_showCount\" type=\"hidden\" name=\"page_showCount\" value=\""
				+ PAGE_SIZE + "\"/>\n");
		sb.append("<div>\n");
		if (getTotalResult() == 0) {
		...
		if (getCurrentPage() - 3 > 0) {
			sb.append("<a class='num' href='javascript:goPage(\""
					+ (getCurrentPage() - 3) + "\");'>"
					+ (getCurrentPage() - 3) + "</a>\n");
		}
		...
		sb.append("<a class='next' href='javascript:goPage(\"" + getTotalPage()
				+ "\");'>&gt;&gt;</a>\n");

		sb.append("<a href='javascript:;' style='border:none;'>总共:"
				+ getTotalResult() + "条&nbsp;/&nbsp;共" + getTotalPage()
				+ "页</a>\n");
